		...
		<div class="row">
			<div class="col-xs-12 col-sm-8">
				<div class="owl-carousel home_page_slider">
					<!-- <div class="item">
				  		<div class="rs_single_slide" style="background-image:url(images/slide_1.jpg); width: 660; height: 380;">
				  		</div>
				  	</div>
				  	<div  class="item">
			...
			<div class="col-xs-12 col-sm-4">
				...
				<% } %>
				<div class="rs_form_box" style="right: 22rem;">
				...
				<div class="text-center">
					<div class="rs_btn_group" style="right: 22rem;">
