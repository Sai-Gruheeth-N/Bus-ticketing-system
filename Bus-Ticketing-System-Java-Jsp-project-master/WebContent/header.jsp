  				...
  				<ul class="nav nav-pills pull-left">
  					<% if(isLogin){ 
  						...
  						if(user.rule.equals("admin")){
							...
							<li  class="nav-item"><a href="<%= Helper.baseUrl %>TrainList.jsp" class="nav-link">Buses</a></li>
							...
							<li class="nav-item"><a href="<%= Helper.baseUrl %>Logout" class="nav-link">Logout</a></li>
  							...
  							<li  class="nav-item"><a href="<%= Helper.baseUrl %>Purchase.jsp" class="nav-link">Book Ticket</a></li>
  							<li class="nav-item"><a href="<%= Helper.baseUrl %>Logout" class="nav-link">Logout</a></li>
